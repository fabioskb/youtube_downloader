...
public class YoutubeText {
     ...
     *
     * @param key (String) - KEYS: DESCRIÇÃO-----------> descricao.
     * BUTTONS-------------> botao.modo.noite, botao.video, botao.audio,
     * botao.pesquisar, botao.baixar, botao.cancelar. fieldtext.link,
     * fieldtext.pesquisar. TOOLTIP------------> tooltip.botao.noturno,
     ...
     * PROGRESSBAR----------> progressbar.baixando.audio. MENU ITEM----------->
