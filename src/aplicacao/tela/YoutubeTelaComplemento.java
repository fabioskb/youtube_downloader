...
public abstract class YoutubeTelaComplemento extends YoutubeTela {
    ...
    protected void eventos() {
        ...
        radioBtnMenuItem6.addActionListener(this::selectRadioMenuItem6);
        radioBtnMenuItem7.addActionListener(this::selectRadioMenuItem7);
        radioBtnMenuItem8.addActionListener(this::selectRadioMenuItem8);
        radioBtnMenuItem9.addActionListener(this::selectRadioMenuItem9);
        radioBtnMenuItem10.addActionListener(this::selectRadioMenuItem10);
        radioBtnMenuItem11.addActionListener(this::selectRadioMenuItem11);
        radioBtnMenuItem12.addActionListener(this::selectRadioMenuItem12);
        radioBtnMenuItem13.addActionListener(this::selectRadioMenuItem13);
        radioBtnMenuItem14.addActionListener(this::selectRadioMenuItem14);
        radioBtnMenuItem15.addActionListener(this::selectRadioMenuItem15);
        radioBtnMenuItem16.addActionListener(this::selectRadioMenuItem16);
        radioBtnMenuItem17.addActionListener(this::selectRadioMenuItem17);
        radioBtnMenuItem18.addActionListener(this::selectRadioMenuItem18);
        radioBtnMenuItem19.addActionListener(this::selectRadioMenuItem19);
        radioBtnMenuItem20.addActionListener(this::selectRadioMenuItem20);
